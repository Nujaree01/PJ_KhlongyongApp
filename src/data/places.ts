...
export const PLACES: Place[] = [
    {
        ...
        description:
            "ตั้งอยู่บนถนนอุทยาน (Utthayan Road) บริเวณรอยต่อกรุงเทพฯ-นครปฐม เป็นสวนสาธารณะขนาดใหญ่ ศูนย์รวมงานพุทธศิลป์และพระพุทธรูปยืนปางลีลาองค์ใหญ่",
        highlight: "สวนพุทธศิลป์ใจกลางเมือง",
    ...
    },
    {
        ...
        description:
            "ตลาดน้ำชื่อดังริมคลองลำพญา สัมผัสวิถีชีวิตริมน้ำ อาหารและของกินท้องถิ่นหลากหลาย เป็นจุดปิดทริปที่สมบูรณ์แบบ",
        highlight: "อาหารพื้นบ้านริมน้ำ",
